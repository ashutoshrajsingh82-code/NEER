...
Phase 29A — core API. The app itself does nothing but wiring: build one
...
from backend.app.routers import dates, embedding, health, model_info, profile, reconstruct
